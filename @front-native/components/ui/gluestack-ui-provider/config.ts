...
/** Palette primary = Tailwind sky (Nuxt UI `primary: 'sky'` sur @front) */
const ludolistPrimaryLight = {
...
/** Même échelle sky — accents plus clairs pour texte / focus sur fond sombre */
const ludolistPrimaryDark = {
  '--color-primary-0': '8 47 73',
...
export const config = {
  ...
  dark: vars({
    ...
    /* Outline */
    '--color-outline-0': '17 24 39',
    '--color-outline-50': '31 41 55',
    '--color-outline-100': '55 65 81',
    '--color-outline-200': '75 85 99',
    ...
    /* Background (gray-900 / gray-800 web) */
    ...
    /* Focus Ring Indicator  */
    '--color-indicator-primary': '56 189 248',
